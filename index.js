...
// Ruta raíz
app.get('/', (req, res) => {
    res.json({ message: '¡Servidor de Twilio Media Stream funcionando!' });
});
...
// Configurar el WebSocket con Express
...
// Ruta para hacer llamadas
app.post('/make-call', (req, res) => {
    const twilioPhoneNumber = process.env.TWILIO_PHONE_NUMBER; // Asegúrate de que esté configurado en el archivo .env
